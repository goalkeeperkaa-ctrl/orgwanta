...
export function FAQ() {
  const items = [
    ...
    { q: "Кто главный — PM или РПД?", a: "Они равны. PM — сроки/бюджет, РПД — качество/методология. Конфликты решает Опер. директор." },
    { q: "Вижу проблему не в моем отделе. Молчать?", a: "Нет! Сообщи своему руководителю или PM. Лучше поднять проблему рано." },
    { q: "Как изменить методологию?", a: "Только через согласование с РПД. Это закон качества." },
